...
const Crafting = (() => {
  const RECIPES = [
    ...
    { id: 'bronze_sword', name: 'Bronze Sword', tier: 2, type: 'weapon', cost: { bronze: 5, wood: 3 }, desc: '12 dmg, balanced' },
    { id: 'bronze_axe', name: 'Bronze Axe', tier: 2, type: 'weapon', cost: { bronze: 5 }, desc: '9 dmg, good gather' },
    { id: 'bronze_pickaxe', name: 'Bronze Pickaxe', tier: 2, type: 'weapon', cost: { bronze: 5, wood: 2 }, desc: 'Mines crystal deposits' },
    { id: 'bronze_armor', name: 'Bronze Armor', tier: 2, type: 'armor', cost: { bronze: 8, leather: 3 }, desc: '+25 HP, slight slow' },
